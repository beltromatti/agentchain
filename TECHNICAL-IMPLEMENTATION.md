...
This document describes how **AgentChain Engine v1.1.4**, the reference C client, realises the protocol specified in `PROTOCOL.md`. Read the protocol first; this document is a companion. Where the implementation deviates from the spec, the deviation is called out explicitly under `§ 9 Spec Deviations`.
...
### 9.6 Patch-release history (v1.0.1 → v1.1.4)
