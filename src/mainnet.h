/* AgentChain — mainnet defaults baked into the binary.
 *
 * Centralising these in one header lets the CLI default to mainnet
 ...
 * just "where mainnet lives right now" goes here.
 *
 * The mainnet genesis is reproduced verbatim from
...
#define AC_MAINNET_SEEDS        "34.61.207.49:30303"
